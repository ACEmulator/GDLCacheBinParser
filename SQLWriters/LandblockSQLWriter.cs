...
namespace PhatACCacheBinParser.SQLWriters
{
    ...
    {
        public static void WriteFiles(IEnumerable<ACE.Database.Models.World.LandblockInstance> input, string outputFolder, IDictionary<uint, string> weenieNames, bool includeDELETEStatementBeforeInsert = false)
        {
