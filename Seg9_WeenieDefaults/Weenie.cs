...
namespace PhatACCacheBinParser.Seg9_WeenieDefaults
{
	class Weenie : IPackable
	{
		...
		public bool Unpack(BinaryReader binaryReader)
		{
			...
			FileVersion = binaryReader.ReadUInt32(); // 02000000, is it always this value?
			...
			{ 
				if ((extendedFlags & 0x01) == 0x01)
				{
					...
					Attributes.Unpack(binaryReader);
				}
            ...
            if (numberOfSubpallets > 0)
            {
                ...
                Palette.Unpack(binaryReader, numberOfSubpallets);
            }
            ...
            // _cache_bin_parse_9_1
			IsAutoGenerated = (binaryReader.ReadByte() == 1); // Always 0x01
